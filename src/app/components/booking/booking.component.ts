        ...
        <div class="row gx-5">
          ...
          <div class="col-lg-6">
            <div class="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
              ...
              <!-- Success Message -->
              <div *ngIf="submitSuccess" class="alert alert-success mb-4">
                <i class="fa fa-check-circle me-2"></i>
                {{ getTranslation('errors.submitSuccess') }}
              </div>
              
              <!-- Error Message -->
              <div *ngIf="submitError" class="alert alert-danger mb-4">
              ...
              <form [formGroup]="bookingForm" (ngSubmit)="onSubmit()">
                <div class="row g-3">
                  ...
                  <div class="col-12">
                    ...
                    >
                      <span *ngIf="!isSubmitting">{{ getTranslation('booking.form.submit') }}</span>
                      <span *ngIf="isSubmitting">
                        <i class="fa fa-spinner fa-spin me-2"></i>
                        {{ getTranslation('booking.form.submitting') }}
                      </span>
                    </button>
                  </div>
                </div>
    ...
    if (this.bookingForm.valid) {
      ...
      this.apiService.submitBooking(formData).subscribe({
        ...
        error: (error) => {
          ...
          this.errorMessage = error.error?.message || 'An error occurred while submitting your booking.';
        },
        complete: () => {
